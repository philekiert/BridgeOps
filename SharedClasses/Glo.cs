...
public static class Glo
{
    ...
    public const int CLIENT_UPDATE_CONTACT = 33;
    public const int CLIENT_UPDATE_ASSET = 34;
    public const int CLIENT_UPDATE_CONFERENCE_TYPE = 35;
    public const int CLIENT_UPDATE_CONFERENCE = 36;
    public const int CLIENT_UPDATE_RESOURCE = 37;
    public const int CLIENT_UPDATE_RECURRENCE = 38;
    ...
    public const int CLIENT_SELECT_HISTORY = 72;
    ...
    public const int CLIENT_CONFERENCE_QUICK_MOVE = 103;
